      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            {nota.itens && nota.itens.length > 0 ? (<div style={{
                ...
                {/* LINHAS */}
                {nota.itens.map((item, idx) => (<div key={item.id} style={{
                    display: 'grid',
                    gridTemplateColumns: '2fr 1fr 1fr 1fr 1.2fr',
                    gap: '1rem',
                    padding: '1rem',
              ...
              </div>) : (<p style={{ color: '#999', textAlign: 'center', padding: '2rem' }}>Nenhum produto</p>)}
          </div>
