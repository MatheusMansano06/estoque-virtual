        ...
        <div className="modal-body">
          ...
          <div className="confirmation-section">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-input" value={quantidadeConfirmada} onChange={(e) => {
          ...
          {temDivergencia && (<>
              ...
              <div className="form-group">
                ...
                <textarea className="form-input" value={observacoes} onChange={(e) => setObservacoes(e.target.value)} placeholder="Digite aqui qualquer observação adicional..." rows={3} style={{ resize: 'vertical' }} disabled={loading}/>
              </div>
            </>)}
